...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { language_id: @sentence.language_id, value: @sentence.value } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { language_id: @sentence.language_id, value: @sentence.value } }
